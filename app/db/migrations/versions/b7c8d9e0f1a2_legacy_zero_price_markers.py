...
def upgrade() -> None:
    ...
    conn.execute(sa.text('UPDATE subscription_groups SET key = \'default\', name = \'默认分组\' WHERE key = \'free-default\''))
    conn.execute(sa.text('UPDATE plans SET group_key = \'default\', group_name = \'默认分组\' WHERE group_key = \'free-default\''))
...
def downgrade() -> None:
    ...
    conn.execute(sa.text('UPDATE subscription_groups SET key = \'free-default\', name = \'免费版默认分组\' WHERE key = \'default\''))
    conn.execute(sa.text('UPDATE plans SET group_key = \'free-default\', group_name = \'免费版默认分组\' WHERE group_key = \'default\''))
